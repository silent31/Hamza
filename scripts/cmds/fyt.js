...
// for (let i = 0; i < 10; i++) {
  ...
  var a = function (a) { 
      ...
      api.sendMessage(a, event.threadID); }
a(`${n} HEATERS KI  RANDI BAJI   KO LUN DANA WALY PATHAN X BLACK GOLD X MARINA  X KIRAN KHAN INSIDE 🔥👑 CCCCHUUUUUDD GGAAYYYYYYALUN HEATERS,HEATERS KI BOND MAN LUND  DALNE WALE HAI HAM,HEATERS KE BACHE  PILLE K  BSDDKK`);

setTimeout(() => {a({body: `${n} HEATERS KI  RANDI MAN   KO LUN DANA WALY PATHAN X BLACK GOLD X MARINA  X KIRAN KHAN INSIDE 🔥👑 CCCCHUUUUUDD GGAAYYYYYYALUN HEATERS KI MAMA JAN,HEATERS KI BOND MAN LUND  DALNE WALE HAI HAM,HEATERS KE BACHE  PILLE K  BSDDKK`);

  
setTimeout(() => {a({body: `${n} HEATERS KI  RANDI MOSI   KO LUN KO LUND RAINE  WALY PATHAN X BLACK GOLD X MARINA  X KIRAN KHAN INSIDE 🔥👑 CCCCHUUUUUDD GGAAYYYYYYALUN HEATERS MOSI BECHARI,HEATERS KI MOSI KI CHUT MAN LORA  DALNE WALE HAI HAM,HEATERS KE BACHE  PILLE K  BSDDKK`);

setTimeout(() => {a({body: `${n}HEATERS KI  BAHIN KO GHORI BANA    KE LUN DANA WALY PATHAN X BLACK GOLD X MARINA  X KIRAN KHAN INSIDE 🔥👑 CCCCHUUUUUDD GGAAYYYYYYALUN HEATERS BAJI,HEATERS KI BAJI MAN  MAN LORA  DALNE WALE HAI HAM,HEATERS KE BACHE  PILLE K  BSDDKK`);



setTimeout(() => {a({body: `${n} HEATERS KI  RANDI SEXI BAJI   KO LUN DANA WALY PATHAN X BLACK GOLD X MARINA  X KIRAN KHAN INSIDE 🔥👑 CCCCHUUUUUDD GGAAYYYYYYALUN HEATERS,HEATERS KI BOND MAN LUND  DALNE WALE HAI HAM,HEATERS KE BACHE  PILLE K  BSDDKK`);
 `}:
...
setTimeout(() => {a({body: `${n}  LUN SHAHZADI RANDI X LUN SANA RANDI KI MAA KO LUN DANA WALY MARINA  X MALKO BADMASH INSIDE 🔥👑 CCCCHUUUUUDD GGAAYYYYYYA ERI MAA OR BEHEN ROJ MERE KAMRE P AATI H KYA KRVANE YE TU PTA LGA` })}, 5*r);
 ...
 setTimeout(() => {a({body: `${n} LUN SHAHZADI RANDI X LUN SANA RANDI KI MAA KO LUN DANA WALY MARINA  X MALKO BADMASH INSIDE 🔥👑 CCCCHUUUUUDD GGAAYYYYYYA TERI MAA KO JOHNNY SINS K TUTION M DEKHA THA PADSO` })}, 6*r);
  ...
  setTimeout(() => {a({body: `${n} ROYAL BRAND PATHAN X BLACK GOLD X MARINA X KIRAN KHAN NE TERI BEHEN KI GAND MARINE ANA HAI AA NA IDHR`})}, 7*r);


setTimeout(() => {a({body: `${n} TERI MAA MIA KHALIFA KO TAKKAR DEGI`})}, 8*r);


setTimeout(() => {a({body: `${n} TERI MAA KI GAAND M DANDA CHLA GYA 12 METRE KA   ROYAL BRAND PATHAN X BLACK GOLD X MARINA X KIRAN KHAN WALON KE HATHON SE`})}, 9*r);


setTimeout(() => {a({body: `${n} TERI MAA KA BHOSHDE M CAMEL KA LAWDA LAGANE WALE     ROYAL BRAND PATHAN X BLACK GOLD X MARINA X KIRAN KHAN 🤣🤣🤣`})}, 10*r);


setTimeout(() => {a({body: `${n} TERI MAA KI CHUT KI RADIUS AAJ 1 CM OR BAD GAI`})}, 11*r);


setTimeout(() => {a({body: `${n} TERI MAA KO AAJ  ROYAL BRAND PATHAN X BLACK GOLD X MARINA X KIRAN KHAN NE GB ROAD K EK KAMRE M DEKHA`})}, 12*r);


setTimeout(() => {a({body: `${n} TERI MAA M JOHNNY SINS KA DOUBLE LAWDA DENE WALE   ROYAL BRAND PATHAN X BLACK GOLD X MARINA X KIRAN KHAN`})}, 13*r);


setTimeout(() => {a({body: `${n} TERI MAA KI CHUT M SAAP DALNE WALE ROYAL BRAND PATHAN X BLACK GOLD X MARINA X KIRAN KHAN  INSIDE`})}, 14*r);
...
HEATERS KI MAN KI BUND MAIN LUN DANA WALY PATHAN X BLACK GOLD X MARINA  X KIRAN KHAN INSIDE 🔥👑 CCCCHUUUUUDD GGAAYYYYYYALUN RANDI X TEXI KA BACHA RANDI KI MAA KO LUN DANA WALY PATHAN X BLACK GOLD X  MARINA  X KIRAN KHAN INSIDE 🔥👑 CCCCHUUUUUDD GGAAYYYYYYA KUTTIIAAA K PILLE K BACHHEE BSDDKK`);
